...
#define SW1_PORT_VALUE        (PORT3.PIDR.BIT.B0)
#define SW2_PORT_VALUE        (PORT3.PIDR.BIT.B1)
#define SW3_PORT_VALUE        (PORTE.PIDR.BIT.B4)
    
/*******************************************************************************
* Global Variables
*******************************************************************************/
void cb_switch_press (void);
extern volatile uint8_t switchPressCallBackFlag;
